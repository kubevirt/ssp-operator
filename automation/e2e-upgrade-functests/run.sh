...
then
  ...
  PAGE=1
  BRANCHES=$(curl -s "https://api.github.com/repos/kubevirt/ssp-operator/branches?page=1")
  ...
  do
    ...
    PAGE=$(($PAGE + 1))
    BRANCHES=$(curl -s "https://api.github.com/repos/kubevirt/ssp-operator/branches?page=$PAGE")
  done
