...
require (
	...
	github.com/openshift/api v0.0.0-20240906151052-5d963dce87aa // release-4.14
	github.com/openshift/custom-resource-status v1.1.2
	github.com/openshift/library-go v0.0.0-20231213084759-840298df1eee // release-4.14
