...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner SSP
...
func (r *ReconcileSSP) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set SSP instance as the owner and controller
...
func newPodForCR(cr *sspv1.SSP) *corev1.Pod {
