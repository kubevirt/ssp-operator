...
func (in *SSPSpec) DeepCopyInto(out *SSPSpec) {
	*out = *in
	...
	if in.VmConsoleProxy != nil {
		in, out := &in.VmConsoleProxy, &out.VmConsoleProxy
		*out = new(VmConsoleProxy)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VmConsoleProxy) DeepCopyInto(out *VmConsoleProxy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VmConsoleProxy.
func (in *VmConsoleProxy) DeepCopy() *VmConsoleProxy {
	if in == nil {
		return nil
	}
	out := new(VmConsoleProxy)
